...
void Lesson16::initDrawData()
{
    glEnable(GL_DEPTH_TEST);
    shader = new ShaderManager("Lesson16.vsh","Lesson16.fsh");
    lightShader = new ShaderManager("Lesson16light.vsh","Lesson16light.fsh");
...
void Lesson16::gameLoop()
{
    shader->useProgram();
    
    glUniform3f(glGetUniformLocation(shader->getShaderProgram(), "light.position"),cameraPos.x, cameraPos.y, cameraPos.z);
    glUniform3f(glGetUniformLocation(shader->getShaderProgram(), "light.direction"),cameraFront.x,cameraFront.y,cameraFront.z);
    glUniform1f(glGetUniformLocation(shader->getShaderProgram(), "light.cutOff"), glm::cos(glm::radians(12.5f)));
    glUniform1f(glGetUniformLocation(shader->getShaderProgram(), "light.outerCutOff"), glm::cos(glm::radians(17.5f)));
    
    glUniform3f(glGetUniformLocation(shader->getShaderProgram(), "light.ambient"),   0.1f, 0.1f, 0.1f);
